...
The target is not "generic clean SaaS." The target is the level of execution seen in Linear, Resend, Dub, OpenStatus, Langfuse, Campsite, Basedash, and Reflect.
...
- Make a product look more like Linear, Resend, Dub, OpenStatus, Langfuse, Campsite, Basedash, or Reflect.
...
2. Inspect existing design system and component conventions.
3. Reduce visual noise before adding decoration.
4. Improve hierarchy through spacing, type, alignment, and surfaces.
5. Refine component states and data density.
6. Validate light/dark mode if applicable.
